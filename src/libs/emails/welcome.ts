			...
			>
			  ...
			  <td class="containerPadding" align="center" valign="middle">
				...
				<tr>
				  ...
				  >
				  We're excited to have you part of our family! Below is some of the most essential information you'll receive. Please take a few minutes to read over it and plan to reference it as needed.
				  </td>
				</tr>
				</table>
			  </td>
			...
			>
			  ...
			  <td class="containerPadding" align="center" valign="middle">
				...
				<tr>
				  ...
				  align="left"
				  valign="middle"
				  style="font-family: Open Sans, Arial, Helvetica, sans-serif; color: #444444; font-size: 18px; line-height: 30px; font-weight: 700; letter-spacing: 0px; padding: 0px;text-align:center;"
				  >
				  What's next?
				  </td>
				</tr>
				<tr>
				  ...
				  will meet our Corporate Staff at Agent Orientation
				  hosted by
				  <a
				  ...
				  information about the tools you now have access to.&nbsp;<br /><br /><a
				  ...
				  will differ from Mikes Agent Orientation. They can help you gain access to some of our tools and familiarize
			...
			>
			  ...
			  <td class="containerPadding" align="center" valign="middle">
				...
				<tr>
				  ...
				  style="font-family: 'Open Sans', Arial, Helvetica, sans-serif; color: #444444; font-size: 16px; line-height: 26px; font-weight: 400; letter-spacing: 0px; padding: 0"
				  >
				  We have a few applications we use which require logins, we've listed some of them below (your <span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">@russlyon.com</span> will be your most important).<br /><br /><b>Email<br /></b>
				  <ul style="list-style-type: none;">
					<li style="margin: 0px; padding: 0px 0px 10px; white-space: nowrap;">
					Login URL -
					<a
					...
					Username - <span style="text-decoration: none; color: #0f90d3; white-space: nowrap;">${preferredName.toLowerCase()}.${last.toLowerCase()}@russlyon.com</span>
					</li>
				  </ul>
				  <b>Lyon Connect<br /></b>
				  <ul style="list-style-type: none;">
					...
					<li style="margin: 0px; padding: 0px 0px 10px">
					Username &amp; Password - you will use Google to sign in. This is your <span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">@russlyon.com</span> email account.
					</li>
				  </ul>
				  <b>Access</b> <span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">(https://access.sir.com)</span><br />
				  <ul style="list-style-type: none;">
					<li style="margin: 0px; padding: 0px 0px 10px">
					Login URL - <span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">https://access.sir.com</span>
					</li>
					<li style="margin: 0px; padding: 0px 0px 10px">
					Username
					-&nbsp;<span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">${preferredName.toLowerCase()}.${last.toLowerCase()}@sothebysrealty.com</span>
					</li>
					<li style="margin: 0px; padding: 0px 0px 10px">
				  ...
				  <ul style="list-style-type: none;">
					...
					<li style="margin: 0px; padding: 0px 0px 10px">
					Username -
					<span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">${preferredName.toLowerCase()}.${last.toLowerCase()}@russlyon.com</span>
					</li>
					<li style="margin: 0px; padding: 0px 0px 10px">
					Temp Password - p1wd
					</li>
				  </ul>
				  <b><p style="text-align: center;">Agent Profile</p></b>Please use this form to submit your
				  personal profile. We will update <span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">russlyon.com</span>, <span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">sir.com</span>, &amp;
				  <span style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3">luxre.com</span> for you.<br>
					<p style="text-align: center;">
					<a href="https://connect.russlyon.com/marketing/5eb0b5464fec825a5d7ed9bf/order"
					  style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3;text-align: center !important;">Agent Profile Form</a></p>
			<br><br>
				  <b><p style="text-align: center;">Links to all Russ Lyon Sotheby’s International Realty systems
					available on - we suggest you bookmark this page:</b>
					<a
					href="https://start.russlyon.com"
					style="text-size-adjust: 100%; text-decoration: none; color: #0f90d3;text-align: center;"
					>https://start.russlyon.com</a>
				  <br /><br />
				  <b
					><p style="font-family: Open Sans, Arial, Helvetica, sans-serif; color: #444444; font-size: 18px; line-height: 30px; font-weight: 700; letter-spacing: 0px; padding: 0px;text-align:center;">Branded Mobile App and Placester Website</p></b>
					We provide you with a branded mobile app and agent website with IDX feeds to your local MLS. Your mobile app and website are branded with our company logo and your contact information. Feel free to add your mobile app to your email signature. Anyone who views your link below will be prompted to download your app.<br /><br /><p  style="text-align: center;"><b>Mobile App </b> </p><p style="text-decoration: none; color: #0f90d3; text-align: center;">https://app.sir.com/sir${preferredName.toLowerCase()}.${last.toLowerCase()}<p><p style="text-decoration: none; text-align: center;"><small> (please allow 72 hours from the time of this email)</small></p>
					<br /><p style="text-decoration: none; text-align: center;"><b>Placester Website</b></p>To sign up for your Placester website, please make the request using this url. <br /><p style="text-decoration: none; color: #0f90d3; text-align: center;">
					<a
			...
			>
			  ...
			  <td class="containerPadding" align="center" valign="middle">
				...
				<tr>
				  ...
				  encourage you to take advantage of both.<br /><p style="text-decoration: none; color: #0f90d3; text-align: center;"><a
			...
			>
			  ...
			  <td class="containerPadding" align="center" valign="middle">
				...
				<tr>
				  ...
				  style="font-family: 'Open Sans', Arial, Helvetica, sans-serif; color: #444444; font-size: 16px; line-height: 26px; font-weight: 400; letter-spacing: 0px; padding: 0"
				  >
				  <br />We look forward to seeing you at Agent Orientation!
				  </td>
				</tr>
				</table>
			  </td>
