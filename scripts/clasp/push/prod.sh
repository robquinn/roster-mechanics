...
clasp settings scriptId $GOOGLE_FORM_HIRE_UPDATE_SCRIPT_ID_PROD
...
clasp settings scriptId $GOOGLE_FORM_SUSPEND_SCRIPT_ID_PROD
...
clasp settings scriptId $GOOGLE_FORM_DELETE_SCRIPT_ID_PROD
...
clasp settings scriptId $GOOGLE_WORKBOOK_SCRIPT_ID_PROD
