const mailAppSendEmailParamsValidation: RosterMechanics.Test.MailApp.Fn.MailAppSendEmailParamsValidation = (
  recipient: string,
  subject: string,
  body: string,
...
export default mailAppSendEmailParamsValidation
