    ...
    const folderTree = new Folder({
      ...
      folders: new FolderIterator([
        new Folder({
          ...
          id: 'Dummy Folder ID 1',
          folders: new FolderIterator([
            new Folder({ name: 'name 1', id: 'asdf', folders: new FolderIterator([]) }),
            new Folder({ name: 'name 2', id: 'asdf', folders: new FolderIterator([]) }),
          ]),
        }),
        new Folder({
          name: 'Dummy Folder 2',
          id: 'Dummy Folder ID 1',
          folders: new FolderIterator([
            new Folder({ name: 'other name 1', id: 'asdf', folders: new FolderIterator([]) }),
            new Folder({ name: 'other name 2', id: 'asdf', folders: new FolderIterator([]) }),
          ]),
        }),
        new Folder({
          name: 'Dummy Folder 3',
